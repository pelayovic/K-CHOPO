...
# ---------------------------------------------------------
# K-CHOPO (Keen Comprehensive High-throughput Omics Pipeline Organizer)
...
#CONFIG_FILE="/home/pelamovic/K-CHOPO/config/config.yml"
...
# Welcome Message
# ------------------------------
pretty_print "K-CHOPO Pipeline - Build 2024"
...
echo "Verifying sequencing summary file..."
...
# Completion Message
# ------------------------------
pretty_print "K-CHOPO Pipeline - Completed"
