...
print_in_color $CYAN "====================================================================================="
print_in_color $CYAN "   🌟 K-CHOPO (Keen Comprehensive High-throughput Omics Pipeline Organizer) 🌟"
print_in_color $CYAN "====================================================================================="
print_in_color $GREEN "K-CHOPO es una herramienta automatizada para el análisis de datos de secuenciación de Nanopore, que integra varios pasos, desde el basecalling hasta la detección de modificaciones epitranscriptómicas."
print_in_color $CYAN "====================================================================================="
print_in_color $CYAN "🌟 Just like a classic Asturian cachopo, K-CHOPO is a hearty and satisfying tool for Nanopore sequencing data analysis! 🧬🍴 Dive in and enjoy the data feast with K-CHOPO! 📊💻"

# Sección de Visión General
print_in_color $YELLOW "\n📜 Overview"
print_in_color $GREEN "K-CHOPO is an automated pipeline for comprehensive analysis of Nanopore sequencing data."
...
print_in_color $GREEN "K-CHOPO uses Snakemake for managing the workflow and dependencies."
...
print_in_color $GREEN "Please cite the tools and references if you use K-CHOPO in your research."
print_in_color $CYAN "Tools Integrated in K-CHOPO:"
...
# Mensaje de cierre
print_in_color $CYAN "====================================================================================="
print_in_color $CYAN "                               ¡Gracias por usar K-CHOPO!"
print_in_color $CYAN "====================================================================================="
